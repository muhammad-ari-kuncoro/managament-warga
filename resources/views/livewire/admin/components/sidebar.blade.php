<div style="margin-top: -10px"
    ...
    <div class="h-screen drawer-side">
        ...
        <ul class="p-4 overflow-y-auto menu w-80 bg-base-100 text-base-content">
          ...
          <hr>
            <li class="mt-5">
                <a href="{{ route("admin.data-rt") }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-files-alt" viewBox="0 0 16 16">
                        <path d="M11 0H3a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2 2 2 0 0 0 2-2V4a2 2 0 0 0-2-2 2 2 0 0 0-2-2zm2 3a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1V3zM2 2a1 1 0 0 1 1-1h8a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V2z"/>
                    </svg>
                    <span class="ml-3">Data RT</span>
                </a>
            </li>
            <li class="mt-3">
                <a href="{{ route("admin.citizen") }}">
                    ...
                    <span class="ml-3">Data Warga</span>
                </a>
            </li>
            <li class="mt-3">
